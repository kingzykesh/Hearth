...
const CHECKIN_PROMPTS = [
  ...
  "Tell Hearth how your day has been so far.",
  "How mentally prepared do you feel today?",
  "What is one thing affecting your mood today?",

  // Energy & Focus
  "On a scale of 1–10, what is your battery level right now?",
  "What has been taking up most of your headspace lately?",
  "Are you feeling more focused or more distracted than usual?",
  "What is your top priority for your wellbeing today?",

  // Emotional Reflection
  "If your current mood was a weather pattern, what would it be?",
  "What is a win—no matter how small—from the last 24 hours?",
  "Is there something you’re holding onto that you’d like to let go of?",
  "How kind have you been to yourself in the past few hours?",

  // Physical & Environmental
  "Take a moment to scan your body—where are you holding tension?",
  "Have you had a chance to step away and breathe today?",
  "How has your physical environment been affecting your mood?",
  "What is one thing you are looking forward to in the coming days?",

  // Short & Modern
  "Describe your morning in three words.",
  "Are you feeling overwhelmed, or do you feel in control?",
  "What’s one thing Hearth can help you track or reflect on right now?",
  "Give yourself a quick check-in: What do you need most at this moment?"
];

export default function NewScreeningPage() {
  const [checkinPrompt] = useState(() => {
  ...
  const uploadRecording = async () => {
    ...
    try {
      ...
      formData.append("checkin_prompt", checkinPrompt);
      ...
      <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.22),transparent_35%),linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))] p-7 shadow-2xl">
        ...
        <div className="relative">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-white/70">
            Answer a dynamic check-in, record your voice, and receive an expanded
            AI Coach result powered by voice biomarkers, Hearth Score, and context.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.35fr_0.95fr]">
            ...
            <div className="rounded-[30px] border border-emerald-400/20 bg-emerald-500/10 p-6 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-100/70">
                    Hearth has processed your voice and generated an expanded AI Coach response.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 rounded-3xl border border-white/10 bg-black/20 p-5">
                <div className="flex items-center gap-2 text-emerald-200">
                  <Wand2 size={18} />
                  <h4 className="font-semibold">AI Coach Result</h4>
                </div>

                <div className="mt-4 whitespace-pre-line text-sm leading-7 text-white/80">
              ...
              <div className="mt-5 rounded-3xl border border-cyan-400/20 bg-cyan-500/10 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">
                      Help Build Hearth Africa Model v1
                    </h4>
                    <p className="mt-2 text-sm leading-7 text-cyan-100/75">
                      Submit a 30-second wellness survey so your anonymized sample
                      can help improve voice AI for African students.
                    </p>
                    <button
                      type="button"
        ...
        <div className="space-y-6">
          <SideCard
            ...
            title="How AI Coach v2 Works"
            items={[
              "Hearth rotates check-in prompts for richer context.",
              "Your voice is analyzed for stress and wellness markers.",
              "The AI Coach explains possible contributors and recovery suggestions.",
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur">
          <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-[32px] border border-white/10 bg-[#07110d] p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-3 text-sm leading-7 text-white/65">
                  Your survey responses and anonymized voice sample may help train
                  future Hearth models. Your identity will not be shared in training exports.
                </p>
              </div>
            ...
            <label className="mt-5 flex items-start gap-3 rounded-2xl border border-cyan-400/20 bg-cyan-500/10 p-4 text-sm leading-7 text-cyan-50/80">
              ...
              />
              <span>
                I agree that my anonymized voice sample and wellness responses may
                be used to improve Hearth AI models and research. I understand this
                is not medical diagnosis.
              </span>
            </label>
